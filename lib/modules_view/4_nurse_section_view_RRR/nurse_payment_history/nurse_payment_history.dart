...
import '../../../controllers/4_nurse_controller_RRR/nurse_payment_history_controller.dart';
...
class NursePaymentHistory extends StatelessWidget {
  ...
  NursePaymentHistoryController _nursePaymentHistoryController =
      Get.put(NursePaymentHistoryController());
  @override
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                                ...
                                itemCount: _nursePaymentHistoryController
                                    .getNursePaymentHistory?.length,
                                itemBuilder: (BuildContext context, int index) {
                                  var item = _nursePaymentHistoryController
                                      .getNursePaymentHistory;
                                  return Stack(
                                    clipBehavior: Clip.none,
                                    children: [
                                      Padding(
