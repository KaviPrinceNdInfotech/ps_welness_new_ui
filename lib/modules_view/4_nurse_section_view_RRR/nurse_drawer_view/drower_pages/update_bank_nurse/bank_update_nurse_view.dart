...
import 'package:ps_welness_new_ui/modules_view/4_nurse_section_view_RRR/nurse_drawer_view/drower_pages/update_bank_nurse/bank_update_nurse_credentials.dart';
import 'package:ps_welness_new_ui/modules_view/4_nurse_section_view_RRR/nurse_drawer_view/drower_pages/update_bank_nurse/bank_update_nurse_headtext.dart';
...
class UpdateBankSeperateNrsDetail extends StatelessWidget {
  UpdateBankSeperateNrsDetail({Key? key}) : super(key: key);
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      UpdateBankNurseHeadText(),
                      UpdateBankNurseCredentials(),
                    ],
                  ),
                ],
              ),
