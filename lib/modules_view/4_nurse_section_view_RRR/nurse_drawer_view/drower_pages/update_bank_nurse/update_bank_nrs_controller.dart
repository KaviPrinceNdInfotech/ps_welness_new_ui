...
class UpdateBankSeperatenrsController extends GetxController {
  final GlobalKey<FormState> updateseperatenrsbankformkey =
      GlobalKey<FormState>();
  ...
  void UpdateBankDetailNurseApi() async {
    CallLoader.loader();
  ...
  void checkUpdateBankSeperateFrDetail() {
    if (updateseperatenrsbankformkey.currentState!.validate()) {
      UpdateBankDetailNurseApi();
    }
    updateseperatenrsbankformkey.currentState!.save();
  }
}
