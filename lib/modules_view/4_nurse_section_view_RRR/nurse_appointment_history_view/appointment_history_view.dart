...
import '../../../controllers/4_nurse_controller_RRR/nurse_appointment_history_controller.dart';
                    ...
                    () => _nurseAppointmentHistoryController.isLoading.value
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                                shrinkWrap: true,
                                itemCount: _nurseAppointmentHistoryController
                                    .getNurseAppointmentHistory?.length,
                                itemBuilder: (BuildContext context, int index) {
                                  var item = _nurseAppointmentHistoryController
                                      .getNurseAppointmentHistory;
                                  return Stack(
                                    clipBehavior: Clip.none,
                                    children: [
                                      Padding(
