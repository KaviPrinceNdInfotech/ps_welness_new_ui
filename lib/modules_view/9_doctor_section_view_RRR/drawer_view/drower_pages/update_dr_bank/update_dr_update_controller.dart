...
class UpdateBankDoctorController extends GetxController {
  final GlobalKey<FormState> updatedrbankformkey = GlobalKey<FormState>();
  ...
  void UpdateBankDoctorApi() async {
    CallLoader.loader();
  ...
  void checkUpdateBankDRDetail() {
    if (updatedrbankformkey.currentState!.validate()) {
      UpdateBankDoctorApi();
    }
    updatedrbankformkey.currentState!.save();
  }
}
