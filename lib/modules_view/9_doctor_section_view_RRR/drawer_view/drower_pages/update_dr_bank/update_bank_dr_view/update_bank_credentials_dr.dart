...
import 'package:ps_welness_new_ui/modules_view/9_doctor_section_view_RRR/drawer_view/drower_pages/update_dr_bank/update_dr_update_controller.dart';
...
class UpdateBankDoctorCredentials extends StatelessWidget {
  UpdateBankDoctorCredentials({Key? key}) : super(key: key);
  // DoctorUpdateBankDetailController _doctorUpdateBankDetailController =
  //     Get.put(DoctorUpdateBankDetailController());

  UpdateBankDoctorController _updateBankSeperateController =
      Get.put(UpdateBankDoctorController());
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _updateBankSeperateController.updatedrbankformkey,
        ...
        child: Column(
          ...
          children: [
            ...
            RectangularButton(
                text: 'Update Bank',
                press: () {
                  _updateBankSeperateController.checkUpdateBankDRDetail();
