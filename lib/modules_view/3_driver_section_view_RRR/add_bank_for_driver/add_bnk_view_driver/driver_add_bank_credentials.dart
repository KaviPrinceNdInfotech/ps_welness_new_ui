...
import 'package:ps_welness_new_ui/modules_view/3_driver_section_view_RRR/add_bank_for_driver/add_bank_driver_controllers/bank_add_driver_controllers.dart';
...
class AdddBankdriverCredentials extends StatelessWidget {
  AdddBankdriverCredentials({Key? key}) : super(key: key);
  // DoctorUpdateBankDetailController _doctorUpdateBankDetailController =
  //     Get.put(DoctorUpdateBankDetailController());

  AdddriverBankController _adddBankController =
      Get.put(AdddriverBankController());
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _adddBankController.addbankdriverrformkey,
