              ...
              : SafeArea(
                  child: Column(
                    ...
                    children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                padding: new EdgeInsets.fromLTRB(8, 12, 8, 8),
                                child: Theme(
                                  data: Theme.of(context).copyWith(
                                      splashColor: Colors.transparent),
                                  child: TextField(
                                    onChanged: (value) =>
                                        _driverAppoinmentDetailController
                                            .filterdriverappointment(value),
                                    autofocus: false,
                                    style: TextStyle(
                      ...
                      _driverAppoinmentDetailController
                              .founappointmentdriver.value.isEmpty
                          ? Center(
                              child: Text("No List"),
                            )
                          : Expanded(
                              child: SizedBox(
                                ...
                                child: ListView.builder(
                                    itemCount: _driverAppoinmentDetailController
                                        .founappointmentdriver?.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      var items =
                                          _driverAppoinmentDetailController
                                              .founappointmentdriver;
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${_driverAppoinmentDetailController.founappointmentdriver[index].joiningDate ?? "00/00/0000"}",
                                                      // date,
                                                      style: TextStyle(
                                                        fontSize:
                                                            size.height * 0.016,
