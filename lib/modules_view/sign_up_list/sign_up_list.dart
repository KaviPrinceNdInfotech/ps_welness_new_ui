                              ...
                              onTap: () async {
                                if (index == 0) {
                                  ...
                                  await SharedPreferences.getInstance().then(
                                      (value) =>
                                          Get.offAll(() => UserSignup1()));
                                  _user_1_controller.dispose();
                                  ...
                                  _franchies_1_controller.dispose();
                                  _franchies_1_controller.onInit();
                                  ...
                                  _lab_1_controller.dispose();
                                  _lab_1_controller.onInit();
                                  //Get.to(() => LabSignup1());
                                } else if (index == 3) {
                                  CallLoader.loader();
                                  await Future.delayed(
                                  ...
                                  _rwa_11_controller.dispose();
                                  _rwa_11_controller.onInit();
                                  // Get.to(() => RwaSignup1());
                                  ...
                                  _chemist_1_controller.dispose();
                                  _chemist_1_controller.onInit();
                                  //Get.to(() => ChemistSignup1());
                                }
                                // else if (index == 7) {
                                //   Get.to(() => ChemistSignup1());
