...
class UpdateBankLabController extends GetxController {
  final GlobalKey<FormState> updatedlabformkey = GlobalKey<FormState>();
  ...
  void checkUpdateBankLabDetail() {
    if (updatedlabformkey.currentState!.validate()) {
      UpdateBankLabApi();
    }
    updatedlabformkey.currentState!.save();
  }
}
