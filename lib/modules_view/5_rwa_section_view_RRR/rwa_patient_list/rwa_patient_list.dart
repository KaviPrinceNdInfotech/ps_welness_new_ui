            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Obx(()=> _rwaPatientListController.isLoading.value ?
                      const Center(child: CircularProgressIndicator())
                    : SizedBox(
                        height: size.height * 0.71,
                        child: ListView.builder(
                            shrinkWrap: true,
                            itemCount: _rwaPatientListController.getRwaPatientList?.patient?.length,
                            itemBuilder: (BuildContext context, int index) {
                              var item = _rwaPatientListController.getRwaPatientList?.patient;
                              return Stack(
                                clipBehavior: Clip.none,
                                children: [
                                  Padding(
