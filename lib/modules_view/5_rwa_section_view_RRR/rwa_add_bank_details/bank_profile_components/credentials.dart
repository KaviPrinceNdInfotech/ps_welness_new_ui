...
class AddRwaBankCredentials extends StatelessWidget {
  AddRwaBankCredentials({Key? key}) : super(key: key);
  // UpdateRwaBankController _updateRwaBankController = Get.put(UpdateRwaBankController());
  final RWAUpdateBankDetailController _rwaUpdateBankDetailController =
        ...
        child: Column(
          ...
          children: [
            ...
            RectangularButton(
                text: 'Add Bank',
                press: () {
                  _rwaUpdateBankDetailController.rwaAddBankDetailApi();
                  //
                  //rwaAddBankDetailApi();
                })
          ],
