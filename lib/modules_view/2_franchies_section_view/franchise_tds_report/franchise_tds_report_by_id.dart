...
class FranchiseTDSSReportByRole extends StatelessWidget {
  FranchiseTDSSReportByRole({Key? key}) : super(key: key);
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            var item = _franchiseTdsHistoryReportController
                                .getfrenchiesTdsReportModelbyid?.tdsReport;
                            return Padding(
