...
class FranchisesgalaryPage extends StatelessWidget {
  FrenchiesGetGalleryController frenchiesGetGalleryController =
      Get.put(FrenchiesGetGalleryController());
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Obx(
                      () => frenchiesGetGalleryController.isLoading.value
                          ? Center(
                          ...
                          : SizedBox(
                              ...
                              child: ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: frenchiesGetGalleryController
                                      .getfranchiseGetGalleryModel
                                      ?.gallery
                                      ?.length,
                                  itemBuilder:
                                      (BuildContext context, int index) {
                                    var item = frenchiesGetGalleryController
                                        .getfranchiseGetGalleryModel?.gallery;
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: () async {
                                                        frenchiesGetGalleryController
                                                            .frenchiesDeleteGallery(
                                                                id!);
                                                        Timer(
                                                            const Duration(
                                                                seconds: 1),
