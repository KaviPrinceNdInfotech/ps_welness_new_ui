...
class MyYmwdreportDoctorCredential extends StatelessWidget {
  MyYmwdreportDoctorCredential({Key? key}) : super(key: key);
                    ...
                    child: Padding(
                      ...
                      child: Obx(
                        () => DropdownButtonFormField(
                            value: _ymwd_controller.selectedTerm.value,
                            ...
                            onChanged: (String? newValue) {
                              _ymwd_controller.selectedTerm.value = newValue!;
                              _ymwd_controller.frenchiesYMDWDoctorReportApi(newValue);
                            }),
                      ),
                    ),
                  ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Theme(
                            ...
                            child: TextField(
                              onChanged: (value)=>  _ymwd_controller.filterPaymentNurse(value),
                              // controller: _ymwd_controller.appointmentController1,
                              // onTap: () {
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: 'search name',//'dd-mm-yyyy',
