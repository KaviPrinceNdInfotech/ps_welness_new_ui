...
class ResitrationVechileDetails extends StatelessWidget {
  ...
  FrenchiesVehicleDetailController _frenchiesVehicleDetailController = Get.put(FrenchiesVehicleDetailController());
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(()=> _frenchiesVehicleDetailController.isLoading.value
                          ...
                          children: [
                            Container(
                              ...
                              child: Theme(
                                ...
                                child: TextField(
                                  onChanged: (value)=>  _frenchiesVehicleDetailController.filterPaymentNurse(value),
                                  autofocus: false,
                                  style: TextStyle(
                      ...
                      _frenchiesVehicleDetailController.data.value.isEmpty
                          ...
                          :
                            ListView.builder(
                                ...
                                itemCount: _frenchiesVehicleDetailController.data.length,
                                itemBuilder: (BuildContext context, int index) {
                                  var item = _frenchiesVehicleDetailController.data;
                                  return Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: size.width * 0.03,
