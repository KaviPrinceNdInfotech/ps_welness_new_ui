...
class EditChemist extends StatefulWidget {
  String id,name,shopName,mobile,email,location,gstNumber,licenceNo;
   EditChemist({Key? key,required this.id,required this.name,required this.shopName,required this.mobile,
     required this.email,required this.location,required this.gstNumber,required this.licenceNo }) : super(key: key);
...
class _EditChemistState extends State<EditChemist> {
  String? id1,name1,shopName1,mobile1,email1,location1,gstNumber1,licenceNo1;
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: 50,
              child: TextFormField(
                controller: id,//_frenchiesChemistDetailController.chemistName,
            ...
            SizedBox(
              height: 50,
              child: TextFormField(
                controller: name,//_frenchiesChemistDetailController.chemistName,
                keyboardType: TextInputType.text,
                maxLines: 1,
                decoration: const InputDecoration(
            ...
            SizedBox(
              height: 50,
              child: TextFormField(
                controller: shop,//_frenchiesChemistDetailController.chemistName,
                keyboardType: TextInputType.text,
                maxLines: 1,
                decoration: const InputDecoration(
                    labelText: 'Shop Name',
            ...
            SizedBox(
              height: 50,
              child: TextFormField(
                controller: mobile,//_frenchiesChemistDetailController.chemistName,
                keyboardType: TextInputType.text,
                maxLines: 1,
                decoration: const InputDecoration(
                    labelText: 'Mobile',
            ...
            SizedBox(
              height: 50,
              child: TextFormField(
                controller: email,//_frenchiesChemistDetailController.chemistName,
                keyboardType: TextInputType.text,
                maxLines: 1,
                decoration: const InputDecoration(
                    labelText: 'Email',
            ...
            SizedBox(
              height: 50,
              child: TextFormField(
                controller: location,//_frenchiesChemistDetailController.chemistName,
                keyboardType: TextInputType.text,
                maxLines: 1,
                decoration: const InputDecoration(
                    labelText: 'Location',
            ...
            InkWell(
              onTap: (){
                 _frenchiesChemistDetailController.FrenchiesEditChemistDetailapi(id.text,name.text,shop.text,mobile.text,email.text,location.text,gst.text,licence.text,);
