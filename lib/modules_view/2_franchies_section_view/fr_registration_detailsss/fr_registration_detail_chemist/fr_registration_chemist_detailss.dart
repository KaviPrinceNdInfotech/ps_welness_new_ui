...
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/fr_registration_detailsss/fr_registration_detail_chemist/fr_reg_chemistEdit.dart';

class ResitrationChemistDetails extends StatelessWidget {
  ResitrationChemistDetails({Key? key}) : super(key: key);
  FrenchiesChemistDetailController _frenchiesChemistDetailController = Get.put(FrenchiesChemistDetailController());
  callTestListView(){
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(()=> _frenchiesChemistDetailController.isLoading.value
                          ...
                          children: [
                            Container(
                              ...
                              child: Theme(
                                ...
                                child: TextField(
                                  onChanged: (value)=>  _frenchiesChemistDetailController.filterPaymentNurse(value),
                                  autofocus: false,
                                  style: TextStyle(
                      ...
                      _frenchiesChemistDetailController.data.value.isEmpty
                          ...
                          :
                            ListView.builder(
                                ...
                                itemCount:  _frenchiesChemistDetailController.data.length,
                                itemBuilder: (BuildContext context, int index) {
                                  var item =  _frenchiesChemistDetailController.data;
                                  var id = _frenchiesChemistDetailController.getfrenchiesChemistDetailModel?.chemistRegDetail?[index].id;
                                  return Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: size.width * 0.03,
                                                        ...
                                                        Row(
                                                          children: [
                                                            InkWell(
                                                              onTap: (){
                                                                //  _dialog(id);
                                                               var name = item?[index].chemistName;
                                                               var shopName = item?[index].shopName;
                                                               var mobileNumber = item?[index].mobileNumber;
                                                               var emailId = item?[index].emailId;
                                                               var location = item?[index].location;
                                                               var gstNumber = item?[index].gstNumber;
                                                               var licenceNumber = item?[index].licenceNumber;
                                                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
                                                                    EditChemist(id: id.toString(),name: name.toString(),shopName: shopName.toString(),
                                                                    mobile: mobileNumber.toString(),email: emailId.toString(),location: location.toString(),
                                                                        gstNumber: gstNumber.toString(),licenceNo: licenceNumber.toString(),)));
                                                              },
                                                              child: Container(
                                                                height:
                                                                    size.height *
                                                            ...
                                                            InkWell(
                                                              onTap: (){
                                                                _frenchiesChemistDetailController.FrenchiesDeleteChemistDetailApi(id!);
