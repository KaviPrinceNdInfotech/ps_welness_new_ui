...
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/fr_registration_detailsss/fr_registration_detail_nurse/fr_all_nurse_details.dart';
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/fr_registration_detailsss/fr_registration_detail_nurse/fr_reg_nurseEdit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(()=> _frenchiesNurseDetailController.isLoading.value
                          ...
                          children: [
                            Container(
                              ...
                              child: Theme(
                                ...
                                child: TextField(
                                  onChanged: (value)=>  _frenchiesNurseDetailController.filterPaymentNurse(value),
                                  autofocus: false,
                                  style: TextStyle(
            ...
            _frenchiesNurseDetailController.data.value.isEmpty
                ...
                : ListView.builder(
                              physics: NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemCount: _frenchiesNurseDetailController.data.length,
                                itemBuilder: (BuildContext context, int index) {
                                  var item = _frenchiesNurseDetailController.data;
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            InkWell(
                                                              onTap: (){
                                                                _frenchiesNurseDetailController.frenchiesDeleteNurseDetailApi(id);
