  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => _frenchiesRWADetailController.isLoading.value
              ? Center(
                          ...
                          children: [
                            ...
                            _frenchiesRWADetailController.data.value.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: _frenchiesRWADetailController
                                        .data.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      var item =
                                          _frenchiesRWADetailController.data;
                            ...
                            ///see all.....commented 9 august 2023.....
                            // Padding(
