...
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/fr_registration_detailsss/fr_registration_detail_lab/fr_all_lab_details.dart';
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/fr_registration_detailsss/fr_registration_detail_lab/fr_reg_labEdit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(()=> _frenchiesLabDetailController.isLoading.value
                          ...
                          children: [
                            Container(
                              ...
                              child: Theme(
                                ...
                                child: TextField(
                                  onChanged: (value)=>  _frenchiesLabDetailController.filterPaymentNurse(value),
                                  autofocus: false,
                                  style: TextStyle(
                          ...
                          :
                            ListView.builder(
                              physics: NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemCount:  _frenchiesLabDetailController.data.length,
                                itemBuilder: (BuildContext context, int index) {
                                  var item =  _frenchiesLabDetailController.data;
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              onTap: (){
                                                                ...
                                                                var gst = item?[index].gstNumber;
                                                                var licence = item?[index].licenceNumber;
                                                                var aadhar = item?[index].aadharNumber;
                                                                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>
                                                                    EditLab(id: id.toString(), name: name.toString(),phone: phone.toString(),
                                                                      mobile: mobile.toString(),email: email.toString(),
                                                                      location: location.toString(),gst: gst.toString(),
                                                                    licence: licence.toString(),aadhar: aadhar.toString(),)));
                                                              },
                                                              child: Container(
                                                                height:
                                                                    size.height *
                                                            ...
                                                            InkWell(
                                                              onTap: (){
                                                                _frenchiesLabDetailController.frenchiesDeleteLabDetailApi(id);
