...
class ResitrationPatientDetails extends StatelessWidget {
  ...
  FrenchiesPatientDetailController _frenchiesPatientDetailController = Get.put(FrenchiesPatientDetailController());
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(()=> _frenchiesPatientDetailController.isLoading.value
                    ...
                    children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Theme(
                                ...
                                child: TextField(
                                  onChanged: (value)=>  _frenchiesPatientDetailController.filterPaymentNurse(value),
                                  autofocus: false,
                                  style: TextStyle(
                      ...
                      ListView.builder(
                        physics: const NeverScrollableScrollPhysics(),
                          shrinkWrap: true,
                          itemCount: _frenchiesPatientDetailController.data.length,
                          itemBuilder: (BuildContext context, int index) {
                            var item = _frenchiesPatientDetailController.data;
                            return Padding(
                              padding: EdgeInsets.symmetric(
                                  horizontal: size.width * 0.03,
