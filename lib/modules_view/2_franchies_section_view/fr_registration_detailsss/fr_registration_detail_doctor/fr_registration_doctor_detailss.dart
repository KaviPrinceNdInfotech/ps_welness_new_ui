...
import 'fr_all_doctors_details.dart';

class ResitrationDoctorDetails extends StatelessWidget {
  ResitrationDoctorDetails({Key? key}) : super(key: key);

  FrenchiesDoctorDetailController _frenchiesDoctorDetailController = Get.put(FrenchiesDoctorDetailController());
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(()=> _frenchiesDoctorDetailController.isLoading.value
                ...
                children: [
                  ...
                  Column(
                    children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Theme(
                                ...
                                child: TextField(
                                  onChanged: (value)=>  _frenchiesDoctorDetailController.filterPaymentNurse(value),
                                  autofocus: false,
                                  style: TextStyle(
                      ...
                      _frenchiesDoctorDetailController.data.value.isEmpty
                          ? Center(child: Text('No List'))
                          :
                      ListView.builder(
                        physics: NeverScrollableScrollPhysics(),
                          shrinkWrap: true,
                          itemCount: _frenchiesDoctorDetailController.data.length,
                          itemBuilder: (BuildContext context, int index) {
                            var item = _frenchiesDoctorDetailController.data;
                            return Padding(
                              padding: EdgeInsets.symmetric(
                                  horizontal: size.width * 0.03,
