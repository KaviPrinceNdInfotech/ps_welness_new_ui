...
class FranchisePaymentReport extends StatelessWidget {
  ...
  FranchisePaymentReportController _franchisePaymentReportController =
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => DropdownButtonFormField<Role>(
                        value: _franchisePaymentReportController
                            .selectedRole.value,
                        ...
                        items: _franchisePaymentReportController.role
                            .map((Role role) {
                        ...
                        onChanged: (Role? newValue) async {
                          _franchisePaymentReportController.selectedRole.value =
                              newValue!;
                          _franchisePaymentReportController
                              .frenchiesPaymentReportApi(newValue.roleName);
                        }),
                  ),
                ),
              ),
            ...
            Obx(() => _franchisePaymentReportController.isLoading.value
                ...
                : _franchisePaymentReportController.data.value.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount:
                            _franchisePaymentReportController.data.length,
