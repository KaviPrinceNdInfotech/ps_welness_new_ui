...
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/franchises_newdrivre_update/update_new_driverrr/update_new_driver.dart';
import 'package:shared_preferences/shared_preferences.dart';

class NewDriverView extends StatelessWidget {
  NewDriverView({Key? key}) : super(key: key);
  FrenchiesNewDriverListController _frenchiesNewDriverListController =
      Get.put(FrenchiesNewDriverListController());
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => _frenchiesNewDriverListController.isLoading.value
              ? const Center(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Theme(
                                      ...
                                      child: TextField(
                                        onChanged: (value) =>
                                            _frenchiesNewDriverListController
                            ...
                            _frenchiesNewDriverListController.data.value.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: _frenchiesNewDriverListController
                                        .data.length,
                                    itemBuilder:
                                      ...
                                      var item =
                                          _frenchiesNewDriverListController
                                              .data;
                                      var id = _frenchiesNewDriverListController
                                          .getfrenchiesNewDriverListModel
                                          ?.newDriver?[index]
                                          .id;
                                      return Padding(
                                        padding: EdgeInsets.symmetric(
          ...
          children: [
            Container(
              ...
              child: TextFormField(
                ...
                onChanged: (value) {
                  _frenchiesNewDriverListController.driverNameController?.text =
                      value;
                },
              ),
            ),
