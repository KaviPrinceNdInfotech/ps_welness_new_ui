...
import 'package:ps_welness_new_ui/modules_view/2_franchies_section_view/franchises_olddrivre_update/franchise%20_old_driver_updates_view/update_old_driver_pages.dart';
import 'package:shared_preferences/shared_preferences.dart';

class OldDriverView extends StatelessWidget {
  FrenchiesOldDriverListController _frenchiesOldDriverListController =
      Get.put(FrenchiesOldDriverListController());
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => _frenchiesOldDriverListController.isLoading.value
              ? Center(
                          ...
                          children: [
                            ...
                            _frenchiesOldDriverListController.data.value.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: _frenchiesOldDriverListController
                                        .data.length,
                                    itemBuilder:
                                      ...
                                      var item =
                                          _frenchiesOldDriverListController
                                              .data;
                                      var id = _frenchiesOldDriverListController
                                          .getfrenchiesOldDriverListModel
                                          ?.getOldDriver?[index]
                                          .id;
                                      return Padding(
                                        padding: EdgeInsets.symmetric(
