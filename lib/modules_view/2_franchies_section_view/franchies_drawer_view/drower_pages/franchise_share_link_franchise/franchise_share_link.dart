...
class SharelinkFranchiseweight extends StatefulWidget {
  const SharelinkFranchiseweight({Key? key}) : super(key: key);

  @override
  SharelinkFranchiseweightState createState() =>
      SharelinkFranchiseweightState();
}

class SharelinkFranchiseweightState extends State<SharelinkFranchiseweight> {
  ...
  Widget build(BuildContext context) {
    ...
    String link =
        'Ps Wellness App link "${_frenchiesProfileDetailController.getfrenchiesProfileDetailModel?.uniqueId.toString()}"';
  ...
  void _onShare(BuildContext context) async {
    String text =
        'This Is My New P S Wellness App Link You can Download and Share It :- ${"https://play.google.com/store/apps/details?id=com.ndinfotech.pswellnessapp.ps_welness_new_ui"}" With FrUID:${_frenchiesProfileDetailController.getfrenchiesProfileDetailModel?.uniqueId.toString()}"';
    String link =
        'Ps Wellness App link with FrID:${_frenchiesProfileDetailController.getfrenchiesProfileDetailModel?.uniqueId.toString()}';
