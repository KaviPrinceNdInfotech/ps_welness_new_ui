...
class NurseUserReportView extends StatelessWidget {
      ...
      body: Obx(
        () => (_nursereportuserviewController.isLoading.value)
            ...
            : _nursereportuserviewController
                        .nurseReportUserImage?.nurseViewReportFile ==
                    null
                ? Center(
                    child: Text("No List"),
                  )
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Image.network(
                                    base +
                                        '${_nursereportuserviewController.nurseReportUserImage?.nurseViewReportFile?[index].file.toString()}',
