...
class DoctorUserreportList extends StatelessWidget {
  DoctorUserreportList({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          _doctorreportuserviewController
                                  .founddoctorruserviewProducts.value.isEmpty
                              ? Center(
                                  child: Text("No List"),
                                )
                              : Expanded(
                                  child: ListView.builder(
                                      ...
                                      itemCount: _doctorreportuserviewController
                                          .founddoctorruserviewProducts.length,
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        SharedPreferences
                                                            ...
                                                            await SharedPreferences
                                                                .getInstance();
                                                        prefs.setString(
                                                            "doctoruserreportlistId",
                                                            "${_doctorreportuserviewController.founddoctorruserviewProducts[index].id.toString()}");
                                                        //_doctorreportuserviewController
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "${_doctorreportuserviewController.founddoctorruserviewProducts[index].doctorName}",
                                                          //'Ram Kumar',
