...
import 'package:ps_welness_new_ui/modules_view/1_user_section_views/user_report_view/nurse_image_report.dart';
import 'package:ps_welness_new_ui/modules_view/circular_loader/circular_loaders.dart';
import 'package:shared_preferences/shared_preferences.dart';
//import 'package:ps_welness/constants/my_theme.dart';
//import 'package:syncfusion_flutter_pdfviewer/pdfviewer.dart';

class NurseUserreportList extends StatelessWidget {
  NurseUserreportList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => (_nursereportuserviewController.isLoading.value)
              ? Center(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          _nursereportuserviewController
                                  .foundnurseuserviewProducts.value.isEmpty
                              ? Center(
                                  child: Text("No List"),
                                )
                              : Expanded(
                                  child: ListView.builder(
                                      ...
                                      itemCount: _nursereportuserviewController
                                          .foundnurseuserviewProducts.length,
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      onTap: () async {
                                                        ...
                                                        SharedPreferences
                                                            ...
                                                            await SharedPreferences
                                                                .getInstance();
                                                        prefs.setString(
                                                            "nurseuserreportlistId",
                                                            "${_nursereportuserviewController.foundnurseuserviewProducts[index].id.toString()}");
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Image.network(
                                                          base +
                                                              '${_nursereportuserviewController.foundnurseuserviewProducts[index].file.toString()}',
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          '',
                                                          //"${_nursereportuserviewController.foundnurseuserviewProducts[index].nurseName}",
                                                          //'Ram Kumar',
