...
import 'package:ps_welness_new_ui/controllers/invoice_controller/ambulance_controller.dart';
import 'package:ps_welness_new_ui/modules_view/1_user_section_views/invoice_views/invoice_ambulance/api_ambulance/pdf_ambulance_api.dart';
import 'package:ps_welness_new_ui/modules_view/1_user_section_views/invoice_views/invoice_ambulance/model_ambulance/invoice.dart';
...
import '../api_ambulance/pdf_ambulance_invoice_api.dart';
import '../model_ambulance/customer.dart';
import '../widget_amblnce/button_widget.dart';
import '../widget_amblnce/title_widget.dart';
...
class PdfPageAmb extends StatelessWidget {
  PdfPageAmb({Key? key}) : super(key: key);
  // HomePageController _homePageController = Get.put(HomePageController());
  InvoiceAmblnceController _invoiceambController =
      Get.put(InvoiceAmblnceController());
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => (_invoiceambController.isLoading.value)
                  ...
                  children: <Widget>[
                    ...
                    ButtonWidget(
                        ...
                        onClicked: () async {
                          ...
                          ///
                          final invoice = InvoiceAmblnce(
                            supplieramblnce: SupplierAmb(
                                name:
                                    "${_invoiceambController.getamblnceinvoice!.name.toString()}",
                                // name: 'N S Bhatt',
                                //"${_invoiceController.getinvoidelist?.name.toString()}",
                                email:
                                    "${_invoiceambController.getamblnceinvoice!.email.toString()}",
                                //"${_invoiceController.getinvoidelist?.email.toString()}",
                                address:
                                    "${_invoiceambController.getamblnceinvoice!.address.toString()}",
                                ...
                                pin:
                                    "Pin:${_invoiceambController.getamblnceinvoice!.pinCode.toString()}",
                            ...
                            customer: Customer(
                              order:
                                  //"pending",
                                  "OrderId:${_invoiceambController.getamblnceinvoice!.orderid.toString()}",
                              invoiceNumber:
                                  //"6767566588",
                                  "InvoiceNo:${_invoiceambController.getamblnceinvoice!.invoiceNumber.toString()}",
                              paymentMethod:
                                  //"online",
                                  "PaymentMode:Online",
                            ...
                            items: [
                              InvoiceItem(
                                ...
                                description:
                                    ...
                                    "${_invoiceambController.getamblnceinvoice!.invoiceData![0].vehicleName.toString()}",
                                // date: DateTime.now(),
                                quantity:
                                    '${_invoiceambController.getamblnceinvoice!.invoiceData![0].driverName}',
                                //"{_invoiceController.getmedicineinvoice!.invoiceData![0].medicineName()}",
                                vat: double.parse(
                                    '${_invoiceambController.getamblnceinvoice!.invoiceData![0].gst.toString()}'),
                                unitPrice: double.parse(
                                    "${_invoiceambController.getamblnceinvoice!.invoiceData![0].amount.toString()}"),
                                total: double.parse(
                                    "${_invoiceambController.getamblnceinvoice!.invoiceData![0].amount.toString()}"),
                              ),
                              // InvoiceItem(
