...
import 'package:ps_welness_new_ui/modules_view/1_user_section_views/invoice_views/invoice_medicine/api/pdf_api.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildTotal() {
    final netTotal =
        _invoiceController.getmedicineinvoice?.finalAmount?.toDouble();
    // invoice.items
    //     .map((item) => item.unitPrice * item.quantity)
    //     .reduce((item1, item2) => item1 + item2);
    final vatPercent = _invoiceController.getmedicineinvoice?.gst?.toDouble();
    //invoice.items.first.vat;
    final vat = _invoiceController.getmedicineinvoice?.gst?.toDouble();
    //double.parse(
    ...
    // 100;
    final total = _invoiceController.getmedicineinvoice!.grandTotal!.toDouble();
    //netTotal + vat;
            ...
            child: Column(
              ...
              children: [
                ...
                buildText(
                  ...
                  value:
                      "${_invoiceController.getmedicineinvoice?.gstAmount?.toDouble()}",
                  unite: true,
                ),
                buildText(
                  ...
                  //'${_invoiceController.getmedicineinvoice?.gst} %',
                  value:
                      "${_invoiceController.getmedicineinvoice?.deliveryCharge?.toDouble()}",
                  unite: true,
                ),
                Divider(),
                buildText(
