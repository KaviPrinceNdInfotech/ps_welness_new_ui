...
class PdfPageDoctor extends StatelessWidget {
  PdfPageDoctor({Key? key}) : super(key: key);
  // HomePageController _homePageController = Get.put(HomePageController());
  InvoiceDrController _invoicedrControllerdr = Get.put(InvoiceDrController());
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => (_invoicedrControllerdr.isLoading.value)
                    ...
                    ButtonWidget(
                        ...
                        onClicked: () async {
                          ...
                          final invoice = Invoice(
                            supplierdr: SupplierDr(
                              name:
                                  "${_invoicedrControllerdr.getdrinvoice!.name.toString()}",
                              // name: 'N S Bhatt',
                              //"${_invoiceController.getinvoidelist?.name.toString()}",
                              email:
                                  "${_invoicedrControllerdr.getdrinvoice!.email.toString()}",
                              //"${_invoiceController.getinvoidelist?.email.toString()}",
                              address:
                                  "${_invoicedrControllerdr.getdrinvoice!.address.toString()}",
                              //"${_invoiceController.getinvoidelist?.address.toString()}",
                              mobile:
                                  "Mobile:${_invoicedrControllerdr.getdrinvoice!.mobileNo.toString()}",
                            ...
                            customer: Customer(
                              order:
                                  //"pending",
                                  "OrderId:${_invoicedrControllerdr.getdrinvoice!.orderId.toString()}",
                              invoiceNumber:
                                  //"6767566588",
                                  "InvoiceNo:${_invoicedrControllerdr.getdrinvoice!.invoiceNumber.toString()}",
                              paymentMethod:
                                  //"online",
                                  "PaymentMode:Online",
                            ...
                            items: [
                              InvoiceItem(
                                ...
                                unitPrice: double.parse(
                                    "${_invoicedrControllerdr.getdrinvoice!.invoiceData![0].fee.toString()}"),
                                total: double.parse(
                                    "${_invoicedrControllerdr.getdrinvoice!.invoiceData![0].totalFee.toString()}"),
                              ),
                              // InvoiceItem(
                              //   description: 'Mango',
                              //   // date: DateTime.now(),
