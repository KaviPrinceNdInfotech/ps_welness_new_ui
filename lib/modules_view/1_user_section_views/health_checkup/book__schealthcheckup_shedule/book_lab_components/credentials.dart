...
class LabScheduleCredentials extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _labListController.Lab3formkey,
      ...
      child: Padding(
        ...
        child:
            //Obx(
            //() =>
            // (_labListController.isLoading.isTrue)
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  controller: _labListController.appointmentController,
                  onTap: () {
                    _labListController.chooseDate();
                  },
            ...
            //         () => DropdownButtonFormField<TimeSlot>(
            //             value:
            //                 _labListController.selectedTimeslot.value,
            //             decoration: InputDecoration(
            //               prefixIcon: Icon(
            //                 Icons.alarm,
            //                 color: Colors.black,
