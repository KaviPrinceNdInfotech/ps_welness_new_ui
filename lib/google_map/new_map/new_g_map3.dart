...
import 'package:ps_welness_new_ui/controllers/1_user_view_controller/ambulance/get_ambulancetype3_controller.dart';
...
class MapView3 extends StatefulWidget {
  ...
  MapView3({Key? key, required this.allowManualEntry}) : super(key: key);

  @override
  _MapView3State createState() => _MapView3State();
}
...
class _MapView3State extends State<MapView3> {
  ...
  Ambulanceget3Controller _ambulanceget3Controller =
