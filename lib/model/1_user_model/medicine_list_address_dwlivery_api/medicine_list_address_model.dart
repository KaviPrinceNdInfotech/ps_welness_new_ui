...
MedicineAddressModel medicineAddressModelFromJson(String str) =>
    MedicineAddressModel.fromJson(json.decode(str));

String medicineAddressModelToJson(MedicineAddressModel data) =>
...
class MedicineAddressModel {
  ...
  factory MedicineAddressModel.fromJson(Map<String, dynamic> json) =>
      MedicineAddressModel(
        addAddressMediciness: json["AddAddressMediciness"] == null
            ? []
            : List<AddAddressMediciness>.from(json["AddAddressMediciness"]!
                .map((x) => AddAddressMediciness.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "AddAddressMediciness": addAddressMediciness == null
            ? []
            : List<dynamic>.from(addAddressMediciness!.map((x) => x.toJson())),
      };
}
...
class AddAddressMediciness {
  ...
  factory AddAddressMediciness.fromJson(Map<String, dynamic> json) =>
      AddAddressMediciness(
        id: json["Id"],
        name: json["Name"],
        mobileNumber: json["MobileNumber"],
