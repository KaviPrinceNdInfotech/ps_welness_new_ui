...
FrenchiesYmdwVehicleModel frenchiesYmdwVehicleModelFromJson(String str) =>
    FrenchiesYmdwVehicleModel.fromJson(json.decode(str));

String frenchiesYmdwVehicleModelToJson(FrenchiesYmdwVehicleModel data) =>
...
class FrenchiesYmdwVehicleModel {
  ...
  factory FrenchiesYmdwVehicleModel.fromJson(Map<String, dynamic> json) =>
      FrenchiesYmdwVehicleModel(
        vehicleYmwdReport: json["VehicleYMWD_Report"] == null
            ? []
            : List<VehicleYmwdReport>.from(json["VehicleYMWD_Report"]!
                .map((x) => VehicleYmwdReport.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "VehicleYMWD_Report": vehicleYmwdReport == null
            ? []
            : List<dynamic>.from(vehicleYmwdReport!.map((x) => x.toJson())),
      };
}
...
class VehicleYmwdReport {
  ...
  factory VehicleYmwdReport.fromJson(Map<String, dynamic> json) =>
      VehicleYmwdReport(
        id: json["Id"],
        vehicleNumber: json["VehicleNumber"],
