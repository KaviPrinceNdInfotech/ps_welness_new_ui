...
//
//     final frenchiesAddVehicleListModel = frenchiesAddVehicleListModelFromJson(jsonString);

import 'dart:convert';

FrenchiesAddVehicleListModel frenchiesAddVehicleListModelFromJson(String str) => FrenchiesAddVehicleListModel.fromJson(json.decode(str));

String frenchiesAddVehicleListModelToJson(FrenchiesAddVehicleListModel data) => json.encode(data.toJson());
