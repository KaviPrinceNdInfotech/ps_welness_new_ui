...
// import 'dart:convert';
//
// RwaBannerModel rwaBannerModelFromJson(String str) =>
//     RwaBannerModel.fromJson(json.decode(str));
//
...
//         bannerImageList: json["BannerImageList"] == null
//             ? []
//             : List<BannerImageList>.from(json["BannerImageList"]!
//                 .map((x) => BannerImageList.fromJson(x))),
//         status: json["status"],
