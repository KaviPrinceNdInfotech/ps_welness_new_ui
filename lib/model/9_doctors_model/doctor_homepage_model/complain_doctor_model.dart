...
DoctorComplainModel complainSubjectModelFromJson(String str) =>
    DoctorComplainModel.fromJson(json.decode(str));

String complainSubjectModelToJson(DoctorComplainModel data) =>
...
class DoctorComplainModel {
  ...
  factory DoctorComplainModel.fromJson(Map<String, dynamic> json) =>
      DoctorComplainModel(
