...
class Lab_2_Controller extends GetxController {
  final GlobalKey<FormState> lab2formkey = GlobalKey<FormState>();
  ...
  void checknurse2() {
    final isValid = lab2formkey.currentState!.validate();
    if (!isValid) {
      return;
    }
    lab2formkey.currentState!.save();
    //Get.to(() => HomePage());
  }
}
