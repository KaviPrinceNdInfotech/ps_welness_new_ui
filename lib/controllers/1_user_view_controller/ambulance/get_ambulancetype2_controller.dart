...
class Ambulanceget2Controller extends GetxController {
  ...
  void ambulancecatagaryy2Api() async {
    ambulancvecatagarys = (await ApiProvider.getambulancecatagary2Api())!;
    print('Prince ambulance catagary list');
    print(ambulancvecatagarys);
  }

  ///get vehicle api...........
  void getvehicletype2(String ambulancecatagaryID) async {
    vhicletypes.clear();
    final localList = await ApiProvider.getvechilebyid2Api(ambulancecatagaryID);
  ...
  void post2AmbulancerequestApi(Set<Marker> markers) async {
  ...
  void googlerequestambulance(Set<Marker> markers) {
    post2AmbulancerequestApi(markers);
