...
class FrDoctor_3_Controller extends GetxController {
  final GlobalKey<FormState> frdoc3formkey = GlobalKey<FormState>();
  ...
  void checknurse2() {
    final isValid = frdoc3formkey.currentState!.validate();
    if (!isValid) {
      return;
    }
    frdoc3formkey.currentState!.save();
    //Get.to(() => HomePage());
  }
}
