...
class YmwdhealthcheckupController extends GetxController {
  final GlobalKey<FormState> ymwdcheckupssformkey = GlobalKey<FormState>();
  ...
  void checknurse2() {
    final isValid = ymwdcheckupssformkey.currentState!.validate();
    if (!isValid) {
      return;
    }
    ymwdcheckupssformkey.currentState!.save();
    //Get.to(() => HomePage());
  }
}
