...
class FrenchiesLabDetailController extends GetxController{
  ...
  void frenchiesEditLabDetailapi(id,String name,String phone,String mobile,String email,String location,String gst, String licence,String aadhar)async{
    isLoading(true);
    http.Response r = await ApiProvider.FrenchiesEditLabDetail(id,name,phone,mobile,email,location,gst,licence,aadhar);
    if(r.statusCode == 200){
      isLoading(false);
    }
  }
