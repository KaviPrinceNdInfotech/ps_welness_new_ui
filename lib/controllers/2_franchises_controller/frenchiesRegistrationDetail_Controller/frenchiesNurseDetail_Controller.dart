...
class FrenchiesNurseDetailController extends GetxController{
  ...
  void frenchiesEditNurseDetailapi(id,String name,String nurseType,String mobile,String email,String location,String c_number)async{
    isLoading(true);
    http.Response r = await ApiProvider.FrenchiesEditNurseDetail(id, name,mobile,email,location,c_number);
    if(r.statusCode == 200){
      isLoading(false);
    }
  }
